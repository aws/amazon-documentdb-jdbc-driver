...
public final class DocumentDbRules {
    ...
    static List<String> mongoFieldNames(final RelDataType rowType,
            final DocumentDbMetadataTable metadataTable, final boolean useOriginalPaths) {
        ...
        return new AbstractList<String>() {
            @Override public String get(final int index) {
                ...
                // For some validations, we may want to get the original path in the collection
                // rather than the current path.
                final String path = !isNullOrWhitespace(column.getResolvedPath()) && !useOriginalPaths
                        ? column.getResolvedPath() : column.getPath();
    ...
    static List<String> mongoFieldNames(final RelDataType rowType, final DocumentDbMetadataTable metadataTable) {
