...
public class DocumentDbQueryMappingServiceBasicTest extends DocumentDbQueryMappingServiceTest {
    ...
    void initialize() throws SQLException {
        ...
        insertBsonDocuments(DATE_COLLECTION_NAME, new BsonDocument[]{doc1});
        insertBsonDocuments(NESTED_ID_COLLECTION_NAME, new BsonDocument[]{nestedIddocument});
        insertBsonDocuments(NESTED_DOCUMENT_IN_NESTED_ARRAY_COLLECTION_NAME, new BsonDocument[]{nestedArrayDocumentInANestedArray});
    ...
    void testQueryWithSelect() throws SQLException {
        ...
        final String nestedTableQuery =
                String.format("SELECT * FROM \"%s\".\"%s\"", getDatabaseName(), COLLECTION_NAME + "_array");
    ...
    void testQueryWithProject() throws SQLException {
        final String query =
                String.format(
                        "SELECT \"%s\" FROM \"%s\".\"%s\"", "field", getDatabaseName(), COLLECTION_NAME + "_array");
    ...
    void testQueryWithDistinct() throws SQLException {
        final String query =
                String.format(
                        ...
                        "field", getDatabaseName(), COLLECTION_NAME + "_array");
        final DocumentDbMqlQueryContext result = queryMapper.get(query);
        Assertions.assertNotNull(result);
        Assertions.assertEquals(COLLECTION_NAME, result.getCollectionName());
        Assertions.assertEquals(1, result.getColumnMetaData().size());
    ...
    void testQueryWithWhere() throws SQLException {
        final String queryWithWhere =
                String.format(
                        ...
                        getDatabaseName(), COLLECTION_NAME + "_array", "field", 1);
        ...
        final String queryWithCompoundWhere =
                String.format(
                        ...
                        getDatabaseName(), COLLECTION_NAME + "_array", "field1", "value", "field", 0);
    ...
    void testQueryWithLimit() throws SQLException {
        final String query =
                String.format(
                        "SELECT * FROM \"%s\".\"%s\" LIMIT 1", getDatabaseName(), COLLECTION_NAME + "_array");
        final DocumentDbMqlQueryContext result = queryMapper.get(query);
        Assertions.assertNotNull(result);
        Assertions.assertEquals(COLLECTION_NAME, result.getCollectionName());
        Assertions.assertEquals(5, result.getColumnMetaData().size());
    ...
    void testQueryWithOrderBy() throws SQLException {
        ...
        final String queryWithCompoundSort =
                String.format(
                        ...
                        getDatabaseName(), COLLECTION_NAME + "_array", "field", "field1");
    ...
    void testQueryWithAggregateFunctions() throws SQLException {
        final String queryWithCount =
                String.format(
                        ...
                        "field1", getDatabaseName(), COLLECTION_NAME + "_array");
    ...
    void testQueryWithSumOne() throws SQLException {
        final String query =
                String.format(
                        "SELECT SUM(1) FROM \"%s\".\"%s\"", getDatabaseName(), COLLECTION_NAME);
        final DocumentDbMqlQueryContext result = queryMapper.get(query);
        Assertions.assertNotNull(result);
        Assertions.assertEquals(COLLECTION_NAME, result.getCollectionName());
        Assertions.assertEquals(1, result.getColumnMetaData().size());
        ...
        final String query =
                String.format(
                        "SELECT CASE " +
                                ...
                                "WHEN \"field\" > 5 THEN 'B' " +
                                "ELSE 'C' END FROM \"%s\".\"%s\"", getDatabaseName(), COLLECTION_NAME + "_array");
        final DocumentDbMqlQueryContext result = queryMapper.get(query);
        Assertions.assertNotNull(result);
        Assertions.assertEquals(COLLECTION_NAME, result.getCollectionName());
        Assertions.assertEquals(1, result.getColumnMetaData().size());
    ...
    void testWhereTwoLiterals() throws SQLException {
        final String query =
                String.format(
                        "SELECT * FROM \"%s\".\"%s\" WHERE 2 > 1", getDatabaseName(), COLLECTION_NAME);
        final DocumentDbMqlQueryContext result = queryMapper.get(query);
        Assertions.assertNotNull(result);
        Assertions.assertEquals(COLLECTION_NAME, result.getCollectionName());
        Assertions.assertEquals(1, result.getColumnMetaData().size());
    ...
    void testQuerySubstring() throws SQLException {
        final String query =
                String.format(
                        "SELECT SUBSTRING(\"field\", 4, 2) FROM \"%s\".\"%s\" WHERE SUBSTRING(\"field\", 2, 3) = 'abc'" , getDatabaseName(), COLLECTION_NAME + "_array");
        final DocumentDbMqlQueryContext result = queryMapper.get(query);
        Assertions.assertNotNull(result);
        Assertions.assertEquals(COLLECTION_NAME, result.getCollectionName());
        Assertions.assertEquals(1, result.getColumnMetaData().size());
    ...
    void testLargeSelectList() throws SQLException {
        final String query = String.format(
            ...
            "field", getDatabaseName(), DATE_COLLECTION_NAME);
        final DocumentDbMqlQueryContext result = queryMapper.get(query);
        Assertions.assertEquals(DATE_COLLECTION_NAME, result.getCollectionName());
    ...
    void testIdAsColumnName() throws SQLException {
        ...
        final String basicQuery =
                String.format("SELECT \"testCollection__id\" AS \"_id\" FROM \"%s\".\"%s\"", getDatabaseName(), COLLECTION_NAME);
        DocumentDbMqlQueryContext result = queryMapper.get(basicQuery);
        Assertions.assertNotNull(result);
        Assertions.assertEquals(COLLECTION_NAME, result.getCollectionName());
        Assertions.assertEquals(1, result.getColumnMetaData().size());
