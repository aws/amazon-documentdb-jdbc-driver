...
public class DocumentDbQueryMappingServiceLiteralTest extends DocumentDbFlapDoodleTest {
    ...
    void testQueryForObjectId() throws SQLException {
        ...
        Assertions.assertEquals(3, result1.getAggregateOperations().size());
        Assertions.assertEquals(BsonDocument.parse(
                "{\"$addFields\": {\"placeholderField1F84EB1G3K47\": {\"$or\": [{\"$eq\": [\"$_id\", {\"$oid\": \"123456789012345678901234\"}]}, {\"$eq\": [\"$_id\", {\"$literal\": \"123456789012345678901234\"}]}]}}}"),
                result1.getAggregateOperations().get(0));
        Assertions.assertEquals(BsonDocument.parse(
                        "{\"$match\": {\"placeholderField1F84EB1G3K47\": {\"$eq\": true}}}"),
                result1.getAggregateOperations().get(1));
        Assertions.assertEquals(BsonDocument.parse(
                        "{\"$project\": {\"placeholderField1F84EB1G3K47\": 0}}"),
        ...
        Assertions.assertEquals(3, result2.getAggregateOperations().size());
        Assertions.assertEquals(BsonDocument.parse(
                        "{\"$addFields\": {\"placeholderField1F84EB1G3K47\": {\"$or\": [{\"$eq\": [\"$_id\", {\"$oid\": \"123456789012345678901234\"}]}, {\"$eq\": [\"$_id\", {\"$literal\": \"123456789012345678901234\"}]}]}}}"),
        ...
        Assertions.assertEquals(BsonDocument.parse(
                        "{\"$project\": {\"placeholderField1F84EB1G3K47\": 0}}"),
                result2.getAggregateOperations().get(2));
        ...
        Assertions.assertEquals(3, result3.getAggregateOperations().size());
        Assertions.assertEquals(BsonDocument.parse(
                        "{\"$addFields\": {\"placeholderField1F84EB1G3K47\": {\"$or\": [{\"$eq\": [\"$_id\", {\"$oid\": \"123456789012345678901234\"}]}, {\"$eq\": [\"$_id\", {\"$binary\": {\"base64\": \"EjRWeJASNFZ4kBI0\", \"subType\": \"00\"}}]}]}}}"),
        ...
        Assertions.assertEquals(BsonDocument.parse(
                        "{\"$project\": {\"placeholderField1F84EB1G3K47\": 0}}"),
                result3.getAggregateOperations().get(2));
        ...
        Assertions.assertEquals(3, result4.getAggregateOperations().size());
        Assertions.assertEquals(BsonDocument.parse(
                        "{\"$addFields\":"
        ...
        Assertions.assertEquals(3, result5.getAggregateOperations().size());
        Assertions.assertEquals(BsonDocument.parse(
                        "{\"$addFields\":"
                                + " {\"placeholderField1F84EB1G3K47\":"
        ...
        Assertions.assertEquals(3, result6.getAggregateOperations().size());
        Assertions.assertEquals(BsonDocument.parse(
                        "{\"$addFields\":"
                                + " {\"placeholderField1F84EB1G3K47\":"
                                + " {\"$eq\": [\"$_id\", {\"$binary\": {\"base64\": \"ASNFZ4mrze8=\", \"subType\": \"00\"}}]}}}"),
        ...
        Assertions.assertEquals(BsonDocument.parse(
                        "{\"$project\": {\"placeholderField1F84EB1G3K47\": 0}}"),
                result6.getAggregateOperations().get(2));
    }
}
